...
class CerrarCaja(QMainWindow):

    def __init__(self, anterior):
        super(CerrarCaja, self).__init__(anterior)
        ...
        self.titulo1 = QLabel()
        self.titulo1.setText("Al terminar el día se podrá ver en esta ventana el "
                             "consolidado de ventas y el efectivo en caja")
